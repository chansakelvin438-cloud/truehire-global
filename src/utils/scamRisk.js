export function analyseJobRisk(job) {
  ...
  const riskRules = [
    ...
    {
      keyword: "application fee",
      reason: "Mentions application fee",
      points: 35,
    },
    {
      keyword: "interview fee",
      reason: "Mentions interview fee",
      points: 35,
    },
    {
      keyword: "medical fee",
      reason: "Mentions medical fee",
      points: 35,
    },
    {
      keyword: "processing fee",
      reason: "Mentions processing fee",
      points: 30,
    },
    {
      keyword: "pay before",
      reason: "Mentions payment before process",
      points: 35,
    },
    {
      keyword: "send money",
      reason: "Requests money transfer",
      points: 40,
    },
    {
      keyword: "urgent payment",
      reason: "Mentions urgent payment",
      points: 40,
    },
    {
      keyword: "whatsapp only",
      reason: "Uses WhatsApp-only communication",
      points: 20,
    },
    {
      keyword: "no experience needed",
      reason: "Uses vague no-experience wording",
      points: 10,
    },
    {
      keyword: "guaranteed job",
      reason: "Promises guaranteed employment",
      points: 25,
    },
  ]
  ...
  if (hasCriticalFeeWarning || score >= 40) {
  level = "High Risk"
  } else if (score >= 20) {
    level = "Medium Risk"
  }
  ...
  return {
    score,
    level,
    reasons: reasons.length > 0 ? reasons : ["No major scam indicators detected"],
  }
}